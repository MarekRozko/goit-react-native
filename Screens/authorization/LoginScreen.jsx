...
import { StyleSheet, View, ImageBackground, TextInput, Text, TouchableOpacity, KeyboardAvoidingView, Platform, Keyboard, TouchableWithoutFeedback,Dimensions} from "react-native";
            ...
            <ImageBackground style={styles.imageLogo} source={require('../../assets/images/Logo-bg.jpg')}>
                    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
                        <View style={styles.formContainer}>
                            <View style={{ ...styles.form, marginBottom: isShowKeyboard ? -245 : -405, width: dimensions,}}>
                                ...
                                <TouchableOpacity activeOpacity={0.8} style={styles.button} onPress={keyboardHide}>
                                    ...
                                    <TouchableOpacity activeOpacity={0.8} ><Text style={{...styles.already,fontFamily:"Roboto-Regular", fontSize: 16 }} onPress={() => navigation.navigate("Registration")}>Don't have an account? Register</Text></TouchableOpacity>
                                </View>
                        </View>
